 ...
 */
cluster_t** k_means(cluster_t**clusters_input, uint64_t num_points, int32_t k, point_t *initial_centroids, point_t *final_centroids, squared_distance_func_t distance_func) ; 
